...
**ARM64 downloads are available for macOS, Windows and Linux in 0.2.10.**
...
```sh
# macOS
shasum -a 256 rexafs-0.2.10-aarch64-apple-darwin.dmg
# Linux
sha256sum rexafs-0.2.10-x86_64-unknown-linux-gnu.tar.gz
```
...
- [TypeScript / JavaScript](/docs/libraries/typescript/): `bun add rexafs@0.2.10`.
- [Rust](/docs/libraries/rust/): `cargo add rexafs@0.2.10`.
