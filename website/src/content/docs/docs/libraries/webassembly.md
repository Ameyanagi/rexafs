...
| Capability | Browser package, 0.2.13 |
|---|---|
...
| MBACK, XANES peak fitting, fluorescence correction and Cauchy wavelets | Available through the native-core bindings |
...
Native rexafs 0.2.13 also uses ReFEFF 0.4.0. Structural fitting, the full desktop
