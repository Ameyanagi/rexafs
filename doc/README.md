...
- [Synthetic copper reduction tutorial](synthetic-copper-reduction.md): step-by-step PCA, MCR, LCF and Series workflows with known fractions, measured recovery errors and ruviz figures.
...
- [Live acquisition](live-acquisition.md): unreleased background monitoring, signal selection, averages and automatic fits.
- [Series EXAFS fits](series-fitting.md): unreleased per-frame fits and parameter expressions with covariance error bars.
- [Plot axis ranges](plot-axis-ranges.md): unreleased independent numeric and automatic display limits.
