...
This guide targets 0.2.10. The [download page](https://rexafs.com/download/) lists
...
desktop targets in 0.2.10, see its
[qualification record](validation/2026-09-18-release-0.2.10/review.md). Windows ARM64
...
[Bun](https://bun.sh/docs/installation) and run `bun add rexafs@0.2.10` in your
application directory. For Rust, use `cargo add rexafs@0.2.10` in a Cargo project.
...
[0.2.10 package archive](https://registry.npmjs.org/rexafs/-/rexafs-0.2.10.tgz)
