...
required. See the [edge-finding implementation](https://github.com/Ameyanagi/rexafs/blob/v0.2.4/crates/rexafs/src/xafs/xafsutils.rs).
...
[xftf_fast_nalgebra](https://github.com/Ameyanagi/rexafs/blob/v0.2.4/crates/rexafs/src/xafs/xrayfft.rs) and the
...
See [window implementations](https://github.com/Ameyanagi/rexafs/blob/v0.2.4/crates/rexafs/src/xafs/xafsutils.rs) and
