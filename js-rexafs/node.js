...
const wavelets = bindWavelet(core);
export const { Wavelet, WaveletMap } = wavelets;
export const FluorescenceCorrection = bindFluorescence(core);
export const Spectrum = bindSpectrum(core, undefined, MBack, wavelets, FluorescenceCorrection);
