...
discontinued. The archived [0.2.11 release](https://github.com/Ameyanagi/rexafs/releases/tag/v0.2.11)
retains the last Intel Mac downloads.
...
**ARM64 downloads are available for macOS, Windows and Linux in 0.2.12.**
...
```sh
# macOS
shasum -a 256 rexafs-0.2.12-aarch64-apple-darwin.dmg
# Linux
sha256sum rexafs-0.2.12-x86_64-unknown-linux-gnu.tar.gz
```
...
- [TypeScript / JavaScript](/docs/libraries/typescript/): `bun add rexafs@0.2.12`.
- [Rust](/docs/libraries/rust/): `cargo add rexafs@0.2.12`.
