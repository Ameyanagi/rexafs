...
This guide targets 0.2.14. The [download page](https://rexafs.com/download/) lists
...
The latest-release link follows new stable versions automatically. For the five
desktop targets in 0.2.14, see its
[qualification record](validation/2026-09-24-release-0.2.14/review.md). Windows ARM64
...
[Bun](https://bun.sh/docs/installation) and run `bun add rexafs@0.2.14` in your
application directory. For Rust, use `cargo add rexafs@0.2.14` in a Cargo project.
...
[0.2.14 package archive](https://registry.npmjs.org/rexafs/-/rexafs-0.2.14.tgz)
