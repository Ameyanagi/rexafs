> **First collection pass (132 files).** These notes are preserved as a historical selection record. The expanded corpus has 222 files; see the [worldwide research report](research/worldwide-beamlines.md) and [current download leads](research/download-leads.csv) for updated coverage and outcomes.
