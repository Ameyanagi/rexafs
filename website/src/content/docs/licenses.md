...
`series-add-trend.jpg` and `series-trend-overview.jpg` in `screenshots/next/`
were captured through computer use on 2026-09-16 from the local development
build. All displayed spectra are generated by
