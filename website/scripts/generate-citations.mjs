...
const sources=['py-rexafs/python/rexafs/__init__.pyi','py-rexafs/python/rexafs/io.pyi','py-rexafs/src/lib.rs','js-rexafs/types.d.ts',...files(resolve(root,'crates/rexafs/src')).filter(p=>p.endsWith('.rs')).map(p=>relative(root,p))];
const found=new Map();
