...
[![The signed rexafs 0.2.13 app showing 53 groups and the 50 marked synthetic spectra](/screenshots/0.2.13/copper-overview.jpg)](/screenshots/0.2.13/copper-overview.jpg)

*Fresh calculation in the signed Apple Silicon 0.2.13 release. The three measured
references are unmarked. This normalized XANES overlay changes the viewing range
only; the stored mixtures were generated from raw absorption.*
...
[![Default uncentered PCA with the Linear scale selected in rexafs 0.2.13](/screenshots/0.2.13/copper-pca.jpg)](/screenshots/0.2.13/copper-pca.jpg)

*The signed release starts with two components for target reconstruction. The
training calculation still retains all its components, and the summary reports
that three exceed the 99.99% squared-signal threshold.*
...
[![Three recovered MCR spectra with full-range Auto controls and 110-iteration convergence](/screenshots/0.2.13/copper-mcr-spectra.jpg)](/screenshots/0.2.13/copper-mcr-spectra.jpg)

[![MCR coefficients across all 50 synthetic frames](/screenshots/0.2.13/copper-mcr-fractions.jpg)](/screenshots/0.2.13/copper-mcr-fractions.jpg)

*Fresh results from the signed 0.2.13 release. These displayed fractions belong
to flattened absorption. Compare them with the raw recipe only after the
edge-step conversion explained below; component numbers are not chemical labels.*
...
[![The 50-frame difference heatmap and final Cu frame minus the first CuO frame](/screenshots/0.2.13/copper-series-difference.jpg)](/screenshots/0.2.13/copper-series-difference.jpg)

*Signed 0.2.13 release, all 50 mixtures selected through **Use marked groups**.
Frame 50 is shown against reference frame 1. The white-line overview below
retains its original per-frame values. All application images are full, unedited
windows; their [capture record](/screenshots/0.2.13/capture.json) identifies the
signed build, inputs and numerical checks.*
...
lines, marker shapes, grids, spines and margins. Comparison markers are reduced
to 3 points; PCA markers keep their default size. Ruviz places legends
automatically.
...
From a source checkout of v0.2.13, these commands extract the
