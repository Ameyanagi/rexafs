...
| **FEFF, ReFEFF and FEFF10** | Programs that compute scattering amplitudes and phases for each path. Every 0.2.10 desktop package includes ReFEFF and FEFF10. Record the engine you used. | [Calculate and select paths](/docs/desktop/structures/#calculate-and-select-paths) |
