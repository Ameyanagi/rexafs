...
Upstream converted/normalized exports are identified separately from native acquisitions.

The `samples/` subset contains 210 files with documented license terms:

| Basis | Files | Terms retained |
| --- | ---: | --- |
| Explicit data dedication | 16 | CC0-1.0 |
| Explicit dataset or spectrum license | 97 | CC-BY-4.0 |
| Explicit dataset license | 19 | CC-BY-NC-SA-4.0 |
| Repository distribution license | 69 | MIT |
| Repository distribution license | 9 | Artistic-1.0-Perl |
